module.exports = {
  ...
  DELETE_USER: (email) => {
    ...
    return {
      statement: `MATCH (user:User)-[:USER_SALE]->(sale:Sale)-[:SALE_PRODUCT]->(product:Product) WHERE user.email = "${email}" DETACH DELETE user DETACH DELETE sale DETACH DELETE product`,
    };
  },
};
