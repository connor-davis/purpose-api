module.exports = {
     ...
     * @param data.description The products description
    ...
    CREATE_PRODUCT: (data, ownerId) => {
        return {
            statement: `
                ...
                WITH user
                CREATE (product:Product { id: $id, name: $name, description: $description, cost: $cost, price: $price })
                CREATE (user)-[:OWNS]->(product)
